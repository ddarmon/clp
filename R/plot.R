...
plot.cconf <- function(obj, conf.level = 0.95, xlim = NULL, xlab = NULL, log = '', which = 1, col = 'black', n.points = 2001){
  ...
  if (class(obj) == 'lm.beta.conf'){
    ...
    curve((obj$cconf(which))(x), xlim = xlim, xlab = xlab, ylab = 'Confidence Curve', n = n.points, lwd = 3, ylim = c(0, 1), log = log, col = col)
...
#' @export plot.pcurve
plot.pcurve <- function(obj, conf.level = 0.95, xlim = NULL, xlab = NULL, log = '', which = 1, col = 'black', n.points = 2001){
  alpha <- 1-conf.level
  ...
  if (class(obj) == 'lm.beta.conf'){
    ...
    ci <- obj$qconf(which)(c(alpha/2, 1 - alpha/2))
    curve((obj$pcurve(which))(x), xlim = xlim, xlab = xlab, ylab = expression(italic(P)*'-curve'), n = n.points, lwd = 3, ylim = c(0, 1), log = log, col = col)
...
#' @export plot.scurve
plot.scurve <- function(obj, conf.level = 0.95, xlim = NULL, xlab = NULL, log = '', which = 1, col = 'black', n.points = 2001){
  alpha <- 1-conf.level
  ...
  if (class(obj) == 'lm.beta.conf'){
    ...
    ci <- obj$qconf(which)(c(alpha/2, 1 - alpha/2))
    curve((obj$scurve(which))(x), xlim = xlim, xlab = xlab, ylab = expression(italic(S)*'-curve (bits)'), n = n.points, lwd = 3, log = log, col = col)
...
plot.dconf <- function(obj, xlim = NULL, xlab = NULL, which = 1, col = 'black', n.points = 2001){
  if (class(obj) == 'lm.beta.conf'){
    ...
    curve(obj$dconf(which)(x), xlim = xlim, xlab = xlab, ylab = 'Confidence Density', n = n.points, lwd = 3, col = col)
  }else{
