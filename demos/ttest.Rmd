...
lc.conf <- t.conf(x = dietstudy$weightchange[weight$diet == 'Low Carb'])

lf.conf <- t.conf(x = dietstudy$weightchange[weight$diet == 'Low Fat'])

comp.conf <- t.conf(x = dietstudy$weightchange[weight$diet == 'Low Carb'], y = weight$weightchange[dietstudy$diet == 'Low Fat'])
